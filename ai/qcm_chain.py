...
template = """You are a teacher preparing questions for a quiz. Given the following document, please generate {question_number} multiple-choice questions (MCQs) of {difficulty} difficulty with 4 options and a corresponding answer letter based on the document.
...
PROMPT = PromptTemplate(
    input_variables=["doc", "question_number", "difficulty"], template=template, output_parser=output_parser
)
